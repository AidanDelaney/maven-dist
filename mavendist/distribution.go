...
func NewDistribution(dependency libpak.BuildpackDependency, cache libpak.DependencyCache, settings []string) (Distribution, libcnb.BOMEntry) {
	contributor, entry := libpak.NewDependencyLayer(dependency, cache, libcnb.LayerTypes{
		Build: true,
		Cache: true,
	})
	return Distribution{LayerContributor: contributor, Settings: settings}, entry
}
